...
#         response = get_dealers_from_cf(url_ds)
#         dealerships = response["entries"]
#         dealer = None

#         # Find the dealership with the matching dealer_id
#         for entry in dealerships:
#             if entry["id"] == dealer_id:
#                 dealer = entry
#                 break
